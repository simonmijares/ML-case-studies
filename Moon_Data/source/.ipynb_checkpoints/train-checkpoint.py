...
if __name__ == '__main__':
    ...
    # Model parameters
    parser.add_argument('--input_dim', type=int, default=1, metavar='IN',
                        help='input dimmension (default: 1)')
    parser.add_argument('--hidden_dim', type=int, default=1, metavar='H',
                        help='hidden dimmension (default: 1)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                        help='output dimmension (default: 1)')
